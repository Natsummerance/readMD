# -*- coding: utf-8 -*-
"""维护由 GitHub Actions 创建的 ReadMD v2.2.4 Release。

用法：
    python release.py --verify [--tag v2.2.4]  # 校验既有 Release 的五个资产
    python release.py --update [--tag v2.2.4]  # 仅更新既有 Release 的标题/说明
...
def main():
    ...
    parser.add_argument("--tag", default="v2.2.4")
    parser.add_argument("--name", default="ReadMD v2.2.4")
