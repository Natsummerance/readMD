...
![version](https://img.shields.io/badge/version-v2.3.7-beta.3-3b6ef5)
...
<p align="center">
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMDSetup-2.3.7-beta.3.exe">
    <img src="https://img.shields.io/badge/⬇️_Windows_Setup-v2.3.7-beta.3-2563eb?style=for-the-badge&logo=windows&logoColor=white" alt="Windows Setup">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-portable-2.3.7-beta.3.exe">
    <img src="https://img.shields.io/badge/⬇️_Windows_Portable-v2.3.7-beta.3-0284c7?style=for-the-badge&logo=windows&logoColor=white" alt="Windows Portable">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-arm64-2.3.7-beta.3.zip">
    <img src="https://img.shields.io/badge/⬇️_macOS_(Apple_Silicon)-v2.3.7-beta.3-111827?style=for-the-badge&logo=apple&logoColor=white" alt="macOS ARM64">
  </a>
  ...
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/readmd_2.3.7-beta.3_amd64.deb">
    <img src="https://img.shields.io/badge/⬇️_Debian_Ubuntu_UOS_Deb-v2.3.7-beta.3-b91c1c?style=for-the-badge&logo=debian&logoColor=white" alt="Deb Package">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/readmd-vscode-2.3.7-beta.3.vsix">
    <img src="https://img.shields.io/badge/🧩_VSCode_VSIX-v2.3.7-beta.3-6366f1?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="VSCode VSIX">
  </a>
...
| :--- | :--- | :--- | :--- |
| 🪟 **Windows** | x64 (Installer) | [⬇️ **ReadMDSetup-2.3.7-beta.3.exe**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMDSetup-2.3.7-beta.3.exe) | Setup wizard with automatic `.md` file associations |
| 💼 **Windows** | x64 (Portable) | [⬇️ **ReadMD-portable-2.3.7-beta.3.exe**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-portable-2.3.7-beta.3.exe) | Standalone single executable, no installation needed |
| 🍏 **macOS** | Apple Silicon (M-Series) | [⬇️ **ReadMD-macos-arm64-2.3.7-beta.3.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-arm64-2.3.7-beta.3.zip) | Native build for Apple Silicon Macs with Vision OCR |
| 💻 **macOS** | Intel x86_64 | [⬇️ **ReadMD-macos-x64-2.3.7-beta.3.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-x64-2.3.7-beta.3.zip) | Native build for Intel Macs with Vision OCR |
| 🐧 **Linux** | x86_64 (AppImage) | [⬇️ **ReadMD-linux-x86_64-2.3.7-beta.3.AppImage**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-linux-x86_64-2.3.7-beta.3.AppImage) | Portable Linux AppImage for Ubuntu, Debian, Fedora, Arch |
...
| 🤖 **MCP Server** | FastMCP stdio Source Package | [⬇️ **readmd-mcp-server-2.3.7-beta.3.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/readmd-mcp-server-2.3.7-beta.3.zip) | FastMCP server with runtime sources and requirements |
...
- **Direct Installation**: Download [`readmd_2.3.7-beta.3_amd64.deb`](https://github.com/Natsummerance/readMD/releases/latest/download/readmd_2.3.7-beta.3_amd64.deb) to install directly, or run [`ReadMD-linux-x86_64-2.3.7-beta.3.AppImage`](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-linux-x86_64-2.3.7-beta.3.AppImage).
...
- **Source Build**: Compile from source in DevEco Studio NEXT (`packages/harmonyos-app/`). No unsigned `.hap` produced outside that toolchain is published.
