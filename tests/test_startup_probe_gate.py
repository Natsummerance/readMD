...
class StartupProbeGateTest(unittest.TestCase):
    def test_valid_samples_pass_numeric_budget(self):
        ...
        self.assertEqual(gate['measured_ms']['page_loaded_median'], 803)
        self.assertEqual(gate['measured_ms']['server_to_window_median'], 50)
    ...
    def test_timeout_missing_or_slow_sample_fails_closed(self):
        ...
        self.assertEqual(len(gate['failures']), 4)
