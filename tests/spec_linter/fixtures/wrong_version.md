...
## —— v1.4.1 Freeze Candidate (True Multiplatform Architecture)

> **版本**：v1.4.1-Candidate (Architecture Freeze Candidate)  
...
35. [34. Change Log (v1.4.2 -> v1.4.1 Freeze Candidate 演进)](#34-change-log-v142---v143-architecture-freeze-candidate-演进)
...
- **Linux Wayland (GNOME)**：通过 Companion 扩展调用 Mutter 原生方法 `metaWindow.make_above()`、`metaWindow.stick()` 与 `metaWindow.hide_from_window_list()`。
...
## 34. Change Log (v1.4.2 -> v1.4.1 Freeze Candidate 演进)
