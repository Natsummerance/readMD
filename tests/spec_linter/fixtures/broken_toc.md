...
9. [虚构未实现章节](#nonexistent-anchor-fail)
...
| **BLOCKER-08** | gtk-layer-shell v0_6 特性链与 Linux 发布锁定 | 调用 protocol_version() 必须显式激活 
0_6；发布配置必须激活 linux-production | Gate-Linux-LayerShellV06 / VAL-27 | **OPEN** |
