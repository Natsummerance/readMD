...
| **T-12** | `ubuntu-24.04-gnome46-x64-wayland-gnomecompanion` | Ubuntu 40/42 (LTS) | x86_64 | Wayland / Mutter | `GnomeCompanionBackend` | **Planned** |
| **T-13** | `ubuntu-24.04-gnome46-arm64-wayland-gnomecompanion` | Ubuntu 40/42 (LTS) | aarch64 | Wayland / Mutter | `GnomeCompanionBackend` | **Planned** |
...
| **T-12** | Ubuntu 40/42 (LTS) | GNOME / x86_64 | `GnomeCompanionBackend` | Phase 0 代表性实机 Spike 环境 |
