...
| **VAL-35** | Golden menu model differential | `architecture` (All) | `integration` | 实测右键菜单 右键菜单 5 项动作 (Pet, Feed, Play, Rest/Wake)、Characters 子菜单、Open reader、disabled header 与 separators 顺序 | `Gate-Golden-Menu` | 无直接阻塞 |
