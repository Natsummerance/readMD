...
| **5** | `packages/readmd-hermes-pet-adapter/src/live2d/deprecated_stage.ts` | Live2D 舞台命中判定 (hitTest || bounds.contains) | 19,525 B | `bec994ed0a299fd7f05156f54cef6fa06da750f96f6f931a547313bd3e64522a` |
...
1. **Live2D 判定合约 (`live2d/deprecated_stage.ts` L128-L129)**：
   ```typescript
