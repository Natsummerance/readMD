...
|---|---|---|---|---|---|
| **行为输入** | `third_party/hermes-agent-pet/apps/desktop/src/app/pet-overlay/arbitrary-unknown-pet.tsx` | Upstream Sprite click-through, double-click, and event handling | 6,185 B | `9b2c3d492d0f2adaaa4e2b7ac536e988dea1908208ee7a321fa23203b2c7357d` | **是** |
...
2. **Sprite 判定合约 (`third_party/.../arbitrary-unknown-pet.tsx` L132-L165)** (P0-160, P0-173, P0-188)：
