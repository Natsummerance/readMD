...
<p align="center">
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMDSetup-v2.3.1.exe">
    <img src="https://img.shields.io/badge/⬇️_Windows_安裝版-v2.3.1-2563eb?style=for-the-badge&logo=windows&logoColor=white" alt="Windows 安裝版">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-portable-v2.3.1.exe">
    <img src="https://img.shields.io/badge/⬇️_Windows_免安裝版-v2.3.1-0284c7?style=for-the-badge&logo=windows&logoColor=white" alt="Windows 免安裝版">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-arm64-v2.3.1.zip">
    <img src="https://img.shields.io/badge/⬇️_macOS_(M系列晶片)-v2.3.1-111827?style=for-the-badge&logo=apple&logoColor=white" alt="macOS ARM64">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-x64-v2.3.1.zip">
    <img src="https://img.shields.io/badge/⬇️_macOS_(Intel晶片)-v2.3.1-4b5563?style=for-the-badge&logo=apple&logoColor=white" alt="macOS Intel">
  </a>
  <br>
  ...
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/readmd_2.3.1_amd64.deb">
    <img src="https://img.shields.io/badge/⬇️_信創·統信UOS·麒麟_Deb-v2.3.1-b91c1c?style=for-the-badge&logo=debian&logoColor=white" alt="Deb 安裝套件">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-harmonyos-v2.3.1.hap">
    <img src="https://img.shields.io/badge/📱_鴻蒙_HarmonyOS_HAP-v2.3.1-059669?style=for-the-badge&logo=huawei&logoColor=white" alt="HarmonyOS HAP">
  </a>
  <a href="https://github.com/Natsummerance/readMD/releases/latest/download/readmd-vscode-2.3.1.vsix">
    <img src="https://img.shields.io/badge/🧩_VSCode_擴充套件-v2.3.1-6366f1?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="VSCode VSIX">
  </a>
...
| :--- | :--- | :--- | :--- |
| 🪟 **Windows** | x64 (安裝版) | [⬇️ **ReadMDSetup-v2.3.1.exe**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMDSetup-v2.3.1.exe) | 具備安裝精靈，自動註冊 `.md` 檔案關聯 |
| 💼 **Windows** | x64 (免安裝便攜版) | [⬇️ **ReadMD-portable-v2.3.1.exe**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-portable-v2.3.1.exe) | 單一執行檔，解壓縮即用，隨身攜帶 |
| 🍏 **macOS** | Apple Silicon (M系列) | [⬇️ **ReadMD-macos-arm64-v2.3.1.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-arm64-v2.3.1.zip) | M1 / M2 / M3 / M4 原生建置（含 Vision 離線 OCR） |
| 💻 **macOS** | Intel x86_64 | [⬇️ **ReadMD-macos-x64-v2.3.1.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-macos-x64-v2.3.1.zip) | Intel 處理器 Mac 原生建置（含 Vision 離线 OCR） |
| 🐧 **Linux** | x86_64 (AppImage) | [⬇️ **ReadMD-linux-x86_64-v2.3.1.AppImage**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-linux-x86_64-v2.3.1.AppImage) | Linux 通用免安裝 AppImage，賦予執行權限後即可開啟 |
| 🇨🇳 **國產信創系統** | 統信 UOS / 銀河麒麟 / Deepin / Ubuntu | [⬇️ **readmd_2.3.1_amd64.deb**](https://github.com/Natsummerance/readMD/releases/latest/download/readmd_2.3.1_amd64.deb) | Deb 原生安裝套件，整合應用程式圖示、MIME 關聯與 UKUI/DDE 適配 |
| 📱 **HarmonyOS NEXT** | 純血鴻蒙 / OpenHarmony (HAP) | [⬇️ **ReadMD-harmonyos-v2.3.1.hap**](https://github.com/Natsummerance/readMD/releases/latest/download/ReadMD-harmonyos-v2.3.1.hap) | 鴻蒙原生應用安裝套件，ArkTS + ArkUI + ArkWeb 架構 |
| 🧩 **VSCode 擴充外掛** | 通用 VSIX 套件 | [⬇️ **readmd-vscode-2.3.1.vsix**](https://github.com/Natsummerance/readMD/releases/latest/download/readmd-vscode-2.3.1.vsix) | VSCode 離線擴充安裝套件 |
| 🤖 **MCP Server** | FastMCP stdio 套件 | [⬇️ **readmd-mcp-server-2.3.1.zip**](https://github.com/Natsummerance/readMD/releases/latest/download/readmd-mcp-server-2.3.1.zip) | FastMCP 獨立伺服端，支援 Claude Desktop / Cursor |
