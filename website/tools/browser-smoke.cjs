...
const routes = ['/', '/download/', '/workflows/', '/large-markdown-files/', '/markdown-to-slides/', '/convert-to-markdown/', '/scan-to-markdown/', '/bibtex-citations/', '/zh-cn/', '/zh-cn/download/', '/zh-cn/workflows/', '/zh-cn/large-markdown-files/', '/zh-cn/markdown-to-slides/', '/zh-cn/convert-to-markdown/', '/zh-cn/scan-to-markdown/', '/zh-cn/bibtex-citations/', '/zh-tw/', '/zh-tw/download/', '/zh-tw/workflows/', '/zh-tw/large-markdown-files/', '/zh-tw/markdown-to-slides/', '/zh-tw/convert-to-markdown/', '/zh-tw/scan-to-markdown/', '/zh-tw/bibtex-citations/', '/ja/', '/ja/download/', '/ja/workflows/', '/ja/large-markdown-files/', '/ja/markdown-to-slides/', '/ja/convert-to-markdown/', '/ja/scan-to-markdown/', '/ja/bibtex-citations/'];
const aiFiles = [
  '/llms.txt',
  '/llms-full.txt',
  '/zh-cn/llms.txt',
